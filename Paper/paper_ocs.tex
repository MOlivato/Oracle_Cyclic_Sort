...
\fancyhead[C]{Oracle Ciclic Sort $\bullet$ \today} % Custom header text
...
\hypersetup{
  colorlinks,
  allcolors=PineGreen,
  pdftitle={Algoritmi di ordinamento: analisi e riduzione del consumo energetico nei dispositivi mobili},
  pdfauthor={Matteo Olivato},
...
\input{2_preliminaries_and_notation}
\input{3_ocs_algorithm}
\input{4_complexity_and_number_of_writes}
%\input{5_conclusion}
